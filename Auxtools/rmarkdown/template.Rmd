...
This report is designed to facilitate summarization and rapid browsing of complex results in PIPP pipelines.
...
The main purpose of this chapter is to describe the basic statistical analysis of polypeptides.

## 2.1 Identified polypeptide length distribution

Amino acid length distribution of the polypeptides.
...
## 2.2 Spectral count of identified polypeptide
...
## 2.5 Summary table of polypeptides
...
This chapter aims to explore the sequence motifs and potential function of the polypeptides via serveral different tools.
...
Gene ontology (GO) is one the fundamental functional classification system. In this sub-section, it was applied to annotate the polypeptides and illustrated as a treemap below:
